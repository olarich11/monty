...
/**
 * strtow - Separates words from a string using specified delimiters.
 *
 * @str: The string to be split into words.
 * @delims: The delimiters used to split the words.
 *
...
/**
 * is_delim - Checks if a character in the stream is a delimiter.
 *
...
/**
 * get_word_length - Retrieves the length of
 * the current word in a string.
 * @str: The string to get the word
 * length from the current word.
...
/**
 * get_word_count - Retrieves the word count from a string.
 *
